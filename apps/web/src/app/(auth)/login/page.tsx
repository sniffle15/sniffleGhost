  ...
  return (
    <div className="w-full max-w-md">
      <div className="dash-panel p-6">
        ...
        <h2 className="mt-1 text-3xl font-display">Login</h2>
        <p className="mt-1 text-sm dash-muted">Use Discord OAuth or local credentials.</p>
        ...
        <div className="mt-5 space-y-4">
          ...
          <p className="text-xs dash-muted">
            No account yet? <a className="underline" href="/register">Create one</a>.
          </p>
        </div>
      </div>
    </div>
