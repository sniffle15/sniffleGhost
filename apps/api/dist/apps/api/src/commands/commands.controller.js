...
__decorate([
    ...
    (0, common_1.UsePipes)(new zod_pipe_1.ZodValidationPipe(shared_1.CommandCreateSchema)),
    __param(0, (0, user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)("id")),
...
__decorate([
    ...
    (0, common_1.UsePipes)(new zod_pipe_1.ZodValidationPipe(shared_1.CommandUpdateSchema)),
    __param(0, (0, user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)("id")),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, common_1.UsePipes)(new zod_pipe_1.ZodValidationPipe(shared_1.CommandVersionCreateSchema)),
    __param(0, (0, user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)("id")),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
