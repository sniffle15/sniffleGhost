...
__decorate([
    (0, common_1.Post)(),
    (0, common_1.UsePipes)(new zod_pipe_1.ZodValidationPipe(shared_1.BotCreateSchema)),
    __param(0, (0, user_decorator_1.CurrentUser)()),
...
__decorate([
    (0, common_1.Patch)(":id"),
    (0, common_1.UsePipes)(new zod_pipe_1.ZodValidationPipe(shared_1.BotUpdateSchema)),
    __param(0, (0, user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)("id")),
